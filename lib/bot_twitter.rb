...
#****************************************************************************
	...
	def bot_twitter(tbl)
		...
		if client != nil
			if 1 == 0 #To avoid 
				5.times do 
					client.update("Bonjour #{(tbl.shuffle)[0]}, je suis en formation chez THP @the_hacking_pro et je dois tweeter aléatoirement... c'est tombé sur toi ... désolé.. <3 #bonjour_monde")
				end
			else
